...
* **Preset tests (`test_presets.py`)**: Verify desktop plugin positions round-trip through presets while current plugin options remain intact, and keep older presets compatible.
