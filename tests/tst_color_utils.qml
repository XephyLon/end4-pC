...
TestCase {
    ...
    property var colorUtils: null

    function initTestCase() {
        var component = Qt.createComponent("../modules/common/functions/ColorUtils.qml")
        if (component.status === Component.Error) {
            fail("Failed to load ColorUtils: " + component.errorString())
        }
        colorUtils = component.createObject(null)
        verify(colorUtils !== null)
    }
